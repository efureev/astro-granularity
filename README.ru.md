...
В `example/` — рабочее приложение на этой интеграции: панель состояния сервисов, три раздела на трёх языках, 22
страницы. Шапка и подвал островами; на каждой странице по одному острову, отрисованному на сервере, и одному
клиентскому.

Lighthouse даёт **100 по доступности, лучшим практикам и SEO** и 99–100 по производительности. Числа, условия замера и
то, чем они достигнуты, — в
